...
class ReadUserInfoController(
    ...
    ): ApiResponse<ReadUserInfoResponse> {
        val readUserInfoResponse = userService.readUserInfo(user)
        return ApiResponse.success(readUserInfoResponse)
    }
}
